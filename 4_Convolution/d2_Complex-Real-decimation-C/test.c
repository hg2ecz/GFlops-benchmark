...
int test3(struct _result *result, const struct _input *input) {
    int decim=DECIM;
    int k=0;
    for (int i=0; i <= input->dlen - input->clen-4*decim+1; i+=4*decim) {
...
int test4(struct _result *result, const struct _input *input) {
    int decim=DECIM;
    int k=0;
    for (int i=0; i <= input->dlen - input->clen-8*decim+1; i+=8*decim) {
...
int test5(struct _result *result, const struct _input *input) {
    int decim=DECIM;
    int k = 0;
    for (int i=0; i <= input->dlen - input->clen-16*decim+1; i+=16*decim) {
