...
float gtest_fmla_c(const float *fvec, int len) {
	...
	res1[0]+=fvec[i+0]*fvec[i+8]; // r0*r2
	res1[1]+=fvec[i+1]*fvec[i+9];
	res1[2]+=fvec[i+2]*fvec[i+10];
	res1[3]+=fvec[i+3]*fvec[i+11];

	res2[0]+=fvec[i+0]*fvec[i+12]; // r0*r3
	res2[1]+=fvec[i+1]*fvec[i+13];
	res2[2]+=fvec[i+2]*fvec[i+14];
	res2[3]+=fvec[i+3]*fvec[i+15];

	res3[0]+=fvec[i+4]*fvec[i+8]; // r1*r2
	res3[1]+=fvec[i+5]*fvec[i+9];
	res3[2]+=fvec[i+6]*fvec[i+10];
	res3[3]+=fvec[i+7]*fvec[i+11];

	res1[0]+=fvec[i+4]*fvec[i+12]; // r1*r3
	res1[1]+=fvec[i+5]*fvec[i+13];
	res1[2]+=fvec[i+6]*fvec[i+14];
	res1[3]+=fvec[i+7]*fvec[i+15];

	res3[0]+=fvec[i+8]*fvec[i+12]; // r2*r3
	res3[1]+=fvec[i+9]*fvec[i+13];
	res3[2]+=fvec[i+10]*fvec[i+14];
	res3[3]+=fvec[i+11]*fvec[i+15];
    }
